...
//        }
    ...
    private ResearchResultSetItem buildVitalResultSet(List<? extends IResearchEncounter> encounters, ResearchFilterItem filters) {
        ...
        for (IResearchEncounter encounter : encounters) {
            ...
            resultItem.setPrimaryValue(currentValue + 1);
            //call for secondary dataset
            generalResultSetCalculator(encounter, filters, resultSet, datasetBuilder, patientIds, patient, resultItem);
            // put result item back into map
    ...
    //do general calculations for vital and age sets
    private void generalResultSetCalculator(IResearchEncounter encounter,
